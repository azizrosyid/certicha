...
export const certichaManagerAbi = [
  ...
  {
    type: 'error',
    inputs: [{ name: 'participant', internalType: 'string', type: 'string' }],
  ...
  },
  {
    ...
    name: 'addProgram',
    outputs: [{ name: 'programId', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
    inputs: [],
    name: 'addressCertichaNFT',
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'participants', internalType: 'string[]', type: 'string[]' },
    ],
  ...
  {
    type: 'function',
    inputs: [{ name: '_programId', internalType: 'uint256', type: 'uint256' }],
    name: 'getProgram',
    outputs: [
